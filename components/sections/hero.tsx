...
export default function Hero() {
  return (
    <div className="relative w-screen h-screen bg-teal-100 overflow-hidden">
      ...
      <motion.img
        className="z-10 absolute bottom-0 right-0 w-1/2 md:w-2/3 lg:w-6/12 h-auto object-right-bottom"
        width={1280}
        height={720}
        // src="/cat-by-table.png"
        src="/dog-mask.png"
      ...
      <div className="absolute top-1/3 lg:top-1/3 left-2 lg:left-96 z-20 text-white w-full">
        ...
        >
          Eco-Friendly, Nutritious and Sustainable Pet Food: Harnessing Invasive
          Fish to Nourish your Pet and Protect Ecosystems.
        </Heading>
        <Link href="/#contact">
